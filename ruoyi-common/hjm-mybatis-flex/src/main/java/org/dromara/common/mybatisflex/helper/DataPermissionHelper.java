package org.dromara.common.mybatisflex.helper;
...
public class DataPermissionHelper {
    ...
    private static final ThreadLocal<Integer> IGNORE_COUNTER = ThreadLocal.withInitial(() -> 0);
    ...
    public static void enableIgnore() {
        int current = IGNORE_COUNTER.get();
        IGNORE_COUNTER.set(current + 1);
    }
