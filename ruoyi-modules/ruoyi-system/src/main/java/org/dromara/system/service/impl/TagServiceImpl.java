    ...
    private QueryWrapper buildQueryWrapper(TagBo bo) {
        ...
        QueryWrapper queryWrapper = QueryWrapper.create()
            .where(
                ...
                .and(TAG.ICON_URL.eq(bo.getIconUrl()))
                .and(TAG.COLOR.eq(bo.getColor()))
                .and(TAG.DESCRIPTION.eq(bo.getDescription()))
                .and(TAG.USE_COUNT.eq(bo.getUseCount()))
                .and(TAG.SORT_ORDER.eq(bo.getSortOrder()))
