...
public interface SysDeptMapper extends BaseMapperPlus<SysDept, SysDeptVo> {
    ...
    default long countDeptById(Long deptId) {
        return this.selectCountByQuery(QueryWrapper.create().eq(SysDept::getDeptId, deptId));
    }
    ...
    default List<Long> selectDeptListByRoleId(Long roleId, boolean deptCheckStrictly) {
        QueryWrapper roleDeptIds = QueryWrapper.create()
            .select("srd.dept_id")
        ...
        if (deptCheckStrictly) {
            ...
            wrapper.notIn(SysDept::getDeptId, parentDeptIds);
        }
